...
class ReportsController extends Controller
{
    ...
    public function index(){
        ...
        ->get(['item_profiles.inventory_number','item_profiles.title','item_profiles.description','item_profiles.classification','item_profiles.purchase_date','serial_numbers.serial_no','serial_numbers.price','serial_numbers.condition','serial_numbers.color','serial_numbers.lifespan','serial_numbers.location',]);
