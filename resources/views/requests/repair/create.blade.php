        ...
        <div class="container bg-white rounded request-information">
            ...
            <div class="row p-3">
                ...
                <div class="d-flex p-3 justify-content-end gap-2">
                    ...
                    <button type="button" class="btn my-btn-primary" id="submit-repair" name="submit_repair">Submit request</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <div class="card-body row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="repair_description" name="description">
                    </div>
                    <div class="mb-3 col-6">
