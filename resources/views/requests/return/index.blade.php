...
@section('content')
        ...
        <div class="row justify-content-center px-2">
            <div class="container bg-white rounded request-information">
                <div class="row p-3 border-bottom border-3 mb-3">
                    ...
                    @if(Auth()->user()->position == 3 || Auth()->user()->position == 1)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            ...
                                            @if ($request->status == 'Approved')
                                                <a
                                                    href="{{ route('downloadPdf', ['id' => $request->id]) }}"class="btn btn-secondary btn-sm rounded-5 p-0">
    ...
    <form action="{{ route('return.destroy') }}" method="post" id="remove-request-return">
        @csrf
        <div class="modal fade" id="remove-warning-return" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
