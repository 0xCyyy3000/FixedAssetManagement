...
<div class="container px-3">
        ...
        <div class="container bg-white rounded request-information">
            ...
            <div class="row p-3">
                ...
                <div class="container mt-5 mb-3">
                    <div class="d-flex justify-content-end mb-3">
                        <button class="btn my-btn-primary" type="button" data-toggle="modal"
                            data-target="#purchase_request_item">Add item</button>
                    </div>
                ...
                <div class="d-flex p-3 justify-content-end gap-2">
                    ...
                    <button type="button" class="btn my-btn-primary" id="submit-purchase" name="submit_purchase">Submit request</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="purchase_request_item" tabindex="-1" aria-labelledby="purchase_request_itemLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title fs-4" id="purchase_request_itemLabel">Item form</h5>
            ...
            <div class="modal-body">
                <div class="card-body row">
                    <div class="mb-3 col-6">
                        ...
                        <select class="form-select" id="purchase_item" name="item">
                            <option value=""></option>
                    ...
                    <div class="mb-3 col-6">
                        ...
                        <select id="purchase_serial_no" class="form-select" name="serial_no">
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <input type="text" class="form-control" id="purchase_description" name="description">
                    </div>
                    <div class="mb-3 col-6">
                        <label for="remarks" class="form-label">Remarks</label>
                        <input type="text" class="form-control" id="purchase_remarks" name="remarks">
                    </div>
                    <div class="mb-3 col-6">
                        <label for="cost" class="form-label">Cost</label>
                        <input type="number" class="form-control" id="purchase_cost" name="cost" value="0">
                    </div>
                    <div class="d-flex justify-content-end gap-2">
                        <button class="btn btn-secondary" data-dismiss="modal" id="cancel" type="button">
                            Cancel
                        </button>
                        <button class="btn my-btn-primary text-white" id="add-item-purchase" type="button">
                            Submit item
                        </button>
                    </div>
                </div>
