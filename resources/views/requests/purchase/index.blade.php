...
@section('content')
                                ...
                                @foreach ($requests as $request)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn btn-danger rounded-5 p-0" id="delete-purchase"
                                                value="{{ $request->id }}"data-bs-toggle="modal"
                                                data-bs-target="#remove-warning-purchase">
    ...
    <form action="{{ route('purchase.destroy') }}" method="post" id="remove-request-purchase">
        @csrf
        <div class="modal fade" id="remove-warning-purchase" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer border-0">
                        <input type="hidden" name="reference" id="purchase_remove_id">
                        <button type="button" class="btn my-bg-third border my-primary"
                            data-bs-dismiss="modal">No,cancel</button>
                        <button type="submit" class="btn my-bg-danger" form="remove-request-purchase">
