                        ...
                        <div class="row">
                          <div class="col-sm">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="transaction_number">
                              </div>
                          ...
                          <div class="col-sm">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="purchase_date">
                              </div>
                              @error('purchase_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                          ...
                          <div class="col-sm">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="purchase_price">
                              </div>
                              @error('purchase_price')
                                ...
                                <div class="col-sm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="inventory_number">
                                    </div>
                                ...
                                <div class="col-sm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="salvage_value">
                                    </div>
                                    @error('salvage_value')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                  <div class="col-sm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="serial_number">
                                      </div>
                                      @error('serial_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                  ...
                                  <div class="col-sm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="classification">
                                      </div>
                                  ...
                                  <div class="col-sm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="lifespan">
                                      </div>
                                      @error('lifespan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    ...
                                    @enderror
                                      ...
                                      <div class="col-sm">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Annual Operating Cost</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1" name="annual_operating">
                                          </div>
                                          @error('annual_operating')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                      @enderror
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" id="exampleFormControlInput1" name="replacement_value">
                                            </div>
                                        ...
                                        <div class="col-sm">
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{ Auth::user()->name }}">
                                            </div>
                                        </div> 
                                      </div> 
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm">
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" id="exampleFormControlInput1" name="trade_value">
                                            </div>
                                            @error('trade_value')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                      ...
                                      <div class="row">
                                        <div class="col-sm">
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" id="exampleFormControlInput1" name="body" >
                                            </div>
                                            @error('body')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm">
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" id="exampleFormControlInput1" name="present_value">
                                            </div>
                                            @error('present_value')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
