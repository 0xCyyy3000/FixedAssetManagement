                ...
                <div class="row p-3">
                    ...
                    <div class="row w-75 m-auto">
                        <div class="mb-3 col-6">
                            ...
                            <input type="text" class="form-control" id="waranty" name="warranty">
                        </div>
                        <div class="mb-3 col-6">
                            <label for="purchase_price" class="form-label">Supplier??</label>
                            <input type="text" class="form-control" id="date" name="supplier">
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <h3 class="text-center fs-4">Items</h3>
                    </div> 
                    <div class="row w-75 m-auto">
                        <div class="mb-2 col-6">
                            <label for="inventory_number" class="form-label">Serial</label>
                            <input type="text" class="form-control" id="serial_no" name="inventory_number">
                        </div>
                        <div class="mb-2 col-6">
                            <label for="inventory_number" class="form-label">Lifespan</label>
                            <input type="text" class="form-control" id="lifespan" name="lifespan">
                        </div>
                        <div class="mb-2 col-6">
                            <label for="inventory_number" class="form-label">Department</label>
                            <input type="text" class="form-control" id="department" name="department" id="department">
                        </div>
                        <div class="mb-3 col-6">
                            <label for="transaction_no" class="form-label">Type</label>
                            <select class="form-select" aria-label="Default select example" name="type"
                                        id="type">
                                        <option value="Functional">Functional</option>
                                        <option value="Non-Functional">Non-Functional</option>
                        ...
                        <div class="mb-2 col-6">
                            <label for="inventory_number" class="form-label">Color</label>
                            <input type="text" class="form-control" id="color" name="color" id="department">
                        </div>
